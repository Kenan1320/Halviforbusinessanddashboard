...
import React, { useEffect, useState, useMemo, SVGProps } from "react";
  ...
  return (
    ...
    >
      ...
      <path
        ...
        className="fill-gray-50 dark:fill-gray-300"
      />
...
const AlNoorGrocery = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const ShawarmaPress = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const HayaThreads = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const BarakaSupermarket = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const KhalilCenter = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const YellowCab = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const RideForRelief = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 100"
    width={100}
...
const allLogos = [
  ...
  { name: "Lowes", Logo: LowesIcon },
  { name: "Ally", Logo: AllyLogo },
  { name: "BMW", Logo: BMWIcon },
  { name: "Nextjs", Logo: NextjsIcon },
  ...
  { name: "Al-Noor Grocery", Logo: AlNoorGrocery },
  { name: "Shawarma Press", Logo: ShawarmaPress },
  { name: "Haya Threads", Logo: HayaThreads },
  { name: "Baraka Supermarket", Logo: BarakaSupermarket },
  { name: "Khalil Center", Logo: KhalilCenter },
  { name: "Yellow Cab", Logo: YellowCab },
  { name: "Ride For Relief", Logo: RideForRelief },
];

// Shuffle array function for random logo display
const shuffleArray = (array: typeof allLogos) => {
...
export function LogoCarousel({ className }: LogoCarouselProps) {
  const [shuffledLogos, setShuffledLogos] = useState<typeof allLogos>([]);
  const [isVisible, setIsVisible] = useState(false);

  useEffect(() => {
    setShuffledLogos(shuffleArray(allLogos));
    setIsVisible(true);
  }, []);
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Trusted by businesses and professionals across the community
          </p>
        </div>
        ...
        >
          {shuffledLogos.map((logo, index) => (
            <motion.div
              ...
              className="flex items-center justify-center p-4 h-24 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300"
            >
              <logo.Logo className="w-auto h-12 max-w-full" />
            </motion.div>
          ))}
        </motion.div>
      </div>
